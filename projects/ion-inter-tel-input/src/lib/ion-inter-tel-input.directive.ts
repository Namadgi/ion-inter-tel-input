...
export class IonInterTelInputValidators {
...
@Directive({
  ...
  selector: '[ionInterTelInputValid]',
  providers: [
    {
      provide: NG_VALIDATORS,
      useExisting: IonInterTelInputValidatorDirective,
      multi: true,
    },
  ],
})
export class IonInterTelInputValidatorDirective implements Validator {
  validate(control: AbstractControl): ValidationErrors | null {
    return IonInterTelInputValidators.phone(control);
  }
}
